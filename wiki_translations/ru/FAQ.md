...
Вы можете попытать удачу и запустить игру. STK имеет запасной рендерер, использующий OpenGL 2.1 / GLES 2 / DirectX 9, которые должны работать на большинстве устройств, но не имеют современного конвейера рендеринга.
