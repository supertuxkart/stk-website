...
For flere detaljer, se venligst [ændringsloggen](https://github.com/supertuxkart/stk-code/blob/master/CHANGELOG.md), [blogindlægget](https://blog.supertuxkart.net) eller listen med løste problemstillinger på STK's GitHub.
...
Se først på [STK bug tracker](https://github.com/supertuxkart/stk-code/issues) og åbn en ny problemstilling, hvis dit problem ikke er blevet indrapporteret.
...
* Med **Flatpak**: den er i `~/.var/app/net.supertuxkart.SuperTuxKart/config/supertuxkart/config-0.10`.
