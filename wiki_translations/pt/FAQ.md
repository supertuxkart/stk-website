...
A versão 0.6 foi lançada em 22 de janeiro de 2009. A jogabilidade foi significativamente melhorada; a física melhorou com o Nitro e a derrapagem. O sistema de som também foi melhorado, foi adicionada música mais interessante e foram adicionadas muitas pistas e karts novos. Também foi lançada a primeira arena especial para vários jogadores para batalhas de 3 strikes e novos itens/powerups para usar.A versão 0.6 foi lançada em janeiro de 2009. Houve um grande melhoramento na jogabilidade, physics melhores com nitro e derrapagens. O sistema de som também foi melhorado, mais músicas, pistas e kars foram adicionados. A primeira arena especial para o modo Batalha multijogador de 3 vidas foi feita, como também novos powerups.
...
Onde está locallizada as configurações?
