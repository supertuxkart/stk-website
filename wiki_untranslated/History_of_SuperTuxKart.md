...
* The [old forum on FreeGameDev](https://web.archive.org/web/20250831014534/https://forum.freegamedev.net/viewforum.php?f=16)). As it is not available anymore on its original domain, you need to navigate through archive.org's snapshots to get access to old threads. Some of them were not archived and are not available anymore, and attachments beyond simple pictures are also missing.
